...
Outputs:
  outputs/pylaia_baseline/pylaia_home_alcar/transcriptions/{stem}.txt
  outputs/pylaia_baseline/pylaia_home_alcar/results.csv  (folio, line_id, transcription)
"""
...
TRANS_DIR = os.path.join(
    _ROOT, "outputs", "pylaia_baseline", "pylaia_home_alcar", "transcriptions"
)
RESULTS_CSV = os.path.join(
    _ROOT, "outputs", "pylaia_baseline", "pylaia_home_alcar", "results.csv"
)

MODEL_ID = "Teklia/pylaia-home-alcar"

# pylaia lives in a separate conda env to avoid torch version conflicts
_PYLAIA_ENV = os.path.join(
...
MODEL_CACHE_DIR = os.path.join(
    os.path.expanduser("~"), ".cache", "pylaia-home-alcar"
)
